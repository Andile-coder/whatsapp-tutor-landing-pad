        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <div className="bg-white rounded-lg p-6 shadow-md border border-gray-100">
              ...
              <p className="text-gray-600 text-sm">
                Your WhatsApp messages with our tutors remain end-to-end
            ...
            <div className="bg-white rounded-lg p-6 shadow-md border border-gray-100">
              ...
              <p className="text-gray-600 text-sm">
                We're committed to being clear about what data we collect and
                how we use it.
              </p>
            </div>
          </div>
          ...
          <section className="mb-10">
            ...
            <p className="mb-4 text-gray-700">
              At WhatsApp Tutor ("we", "our", or "us"), we respect your privacy
              and are committed to protecting your personal data. This Privacy
              Policy explains how we collect, use, disclose, and safeguard your
              information when you use our tutoring services via WhatsApp.
            </p>
            <p className="mb-4 text-gray-700">
          ...
          <section className="mb-10">
            ...
            <div className="mb-6">
              <h3 className="text-xl font-heading font-medium mb-3 text-tutoring-blue">
            ...
            <div className="mb-6">
              <h3 className="text-xl font-heading font-medium mb-3 text-tutoring-blue">
                2.2 WhatsApp Communication Data
              </h3>
              <p className="mb-3 text-gray-700">
                When you interact with our tutors through WhatsApp, we may
                collect:
              </p>
              <ul className="list-disc pl-6 mb-3 text-gray-700 space-y-2">
                <li>Message content related to tutoring sessions</li>
                <li>
                  Files, images, and documents you share for educational
                  purposes
                </li>
                <li>Session timing and frequency</li>
              </ul>
              <p className="text-gray-700">
                Please note that WhatsApp's end-to-end encryption ensures that
                only you and our tutors can read the messages exchanged.
              </p>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="flex items-start mb-4">
              ...
              <p className="text-gray-700">
                To provide, maintain, and improve our tutoring services
              </p>
            </div>
            <div className="flex items-start mb-4">
              <FileCheck className="h-5 w-5 text-whatsapp mr-3 mt-1 flex-shrink-0" />
            ...
            <div className="flex items-start mb-4">
              <FileCheck className="h-5 w-5 text-whatsapp mr-3 mt-1 flex-shrink-0" />
              <p className="text-gray-700">
                To match you with appropriate tutors based on your educational
                needs
              </p>
            </div>
            <div className="flex items-start mb-4">
            ...
            <div className="flex items-start mb-4">
              <FileCheck className="h-5 w-5 text-whatsapp mr-3 mt-1 flex-shrink-0" />
              <p className="text-gray-700">
                To analyze usage patterns and improve our educational content
              </p>
            </div>
            <div className="flex items-start mb-4">
              <FileCheck className="h-5 w-5 text-whatsapp mr-3 mt-1 flex-shrink-0" />
          ...
          <section className="mb-10">
            ...
            <div className="flex items-start mb-6">
              ...
              <div>
                ...
                <p className="text-gray-700">
                  WhatsApp messages exchanged during tutoring sessions may be
                  retained for quality assurance and educational improvement
                  purposes for up to 12 months after your last session.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="flex items-start mb-6">
              ...
              <div>
                ...
                <p className="text-gray-700">
                  While we strive to protect your personal information, please
